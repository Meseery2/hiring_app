...
class JobApplicationsListScreenState extends State<JobApplicationsListScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<JobApplicationsListBloc, JobApplicationsListState>(
      ...
      Scaffold(
        ...
        body: ListView.builder(
            ...
            itemBuilder: (context, position) {
              return Dismissible(
                key: Key(state.applications[position].toString()),
                background: _slideRightBackground(),
                secondaryBackground: _slideLeftBackground(),
                child: jobApplicationnComponent(
                  application: state.applications[position],
                  ...
                  if (direction == DismissDirection.endToStart) {
                    ...
                    _bloc.add(
                      JobApplicationsListDeleteApplicationEvent(
                        applicationId: state.applications[position].id,
                      ),
                    );
                  }
                },
          ...
          children: [
            Row(
              ...
              children: [
                ...
                PopupMenuButton(
                  itemBuilder: (context) {
                    final values = applicationStatuses.map((status) {
  ...
  void _actionPopUpItemSelected({
    ...
    required String statusValue,
      ...
      _bloc.add(JobApplicationsListUpdateApplicationEvent(
